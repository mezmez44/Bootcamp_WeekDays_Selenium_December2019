...
public class WebAPI {
    ...
    public WebDriver getLocalDriver(   @Optional("mac")    String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.chrome.driver", "../Generic/BrowserDriver/chromdriver.exe");
            } else if (OS.equalsIgnoreCase("Windows")) {
                System.setProperty("webdriver.chrome.driver", "/Users/mezibena/IdeaProjects/Team3_WebAutomationFrameWork/Generic/BrowserDriver/mac/chromdriver");
            }
    ...
    public static void scrollToWebElement(String path){
        ((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();",driver.findElement(By.xpath(path)));
    }
...
//Dragged and dropped.
    ...
    public void SelectFromDropDownList(String path){
        Select selectFromDrop = new Select(driver.findElement(By.xpath(path)));
